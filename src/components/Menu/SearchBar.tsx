...
const SearchBar = () => {
  ...
  return (
    <div className="flex justify-around items-center w-full bg-tertiary-orange h-11 my-20 rounded-t-xl text-center">
      ...
      <select className="text-center shadow" name="cars" id="cars" onChange={(e) => setSorting(e.target.value)}>
      ...
      />
      <div className="w-1/12 h-1/2 bg-white text-lg leading-5 shadow">
        Filtry▾
      </div>
    </div>
  );
